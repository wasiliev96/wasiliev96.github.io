...
const phraselist = [
    ...
    "Серьезно: стараюсь использовать минимум js для максимальной скорости загрузки",
    "... и адекватном отображении в условиях тайги",
    "Уровень владения ЯП - могу написать простую нейросеть на js, java, C#, Python",
